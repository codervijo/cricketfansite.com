...
Then read the row for `cricketfansite.com`. Or pull from
...
- **Action:** project scaffolded via `portfolio new bootstrap`; first deploy
  pending. After deploy: verify in GSC as `sc-domain:cricketfansite.com` and submit
  the sitemap.
